const _LEVEL_1 = {
  "_container28_viewKeys": ["View 1"] as const,
  "_container28_views": [{
      "_selector": ["container28","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container28 = {
  "_selector": ["container28"] as const,
  "_isPlugin": true,
  "id": "container28",
    /**
  ...
  **/
  ...
  "viewKeys": _LEVEL_1["_container28_viewKeys"] as RetoolArrayWrapper<["container28","viewKeys"], typeof _LEVEL_1["_container28_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container28_views"] as RetoolArrayWrapper<["container28","views"], typeof _LEVEL_1["_container28_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container28","style"] as const,
    "background": "#3d9dd9"
  } as const,
