const _LEVEL_1 = {
  "_container27_viewKeys": ["View 1"] as const,
  "_container27_views": [{
      "_selector": ["container27","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container27 = {
  "_selector": ["container27"] as const,
  "_isPlugin": true,
  "id": "container27",
  ...
  "viewKeys": _LEVEL_1["_container27_viewKeys"] as RetoolArrayWrapper<["container27","viewKeys"], typeof _LEVEL_1["_container27_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container27_views"] as RetoolArrayWrapper<["container27","views"], typeof _LEVEL_1["_container27_views"], 1>,
