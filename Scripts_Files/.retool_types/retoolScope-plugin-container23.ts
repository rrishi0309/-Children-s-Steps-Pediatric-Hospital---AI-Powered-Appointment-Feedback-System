const _LEVEL_1 = {
  "_container23_viewKeys": ["View 1"] as const,
  "_container23_views": [{
      "_selector": ["container23","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container23 = {
  "_selector": ["container23"] as const,
  "_isPlugin": true,
  "id": "container23",
    /**
  ...
  **/
  ...
  "viewKeys": _LEVEL_1["_container23_viewKeys"] as RetoolArrayWrapper<["container23","viewKeys"], typeof _LEVEL_1["_container23_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container23_views"] as RetoolArrayWrapper<["container23","views"], typeof _LEVEL_1["_container23_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container23","style"] as const,
