const _LEVEL_1 = {
  "_button13_events": [{
      "_selector": ["button13","events","0"] as const,
      "event": "click",
      "type": "widget",
      "method": "show",
...
const button13 = {
  ...
  "events": _LEVEL_1["_button13_events"] as RetoolArrayWrapper<["button13","events"], typeof _LEVEL_1["_button13_events"], 1>,
