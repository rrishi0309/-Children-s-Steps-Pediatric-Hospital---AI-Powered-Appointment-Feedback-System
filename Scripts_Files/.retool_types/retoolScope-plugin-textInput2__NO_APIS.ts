const _LEVEL_1 = {
  "_textInput2_events": [{
      "_selector": ["textInput2","events","0"] as const,
      "method": "setDisabled",
      "enabled": true,
      "params": {
        "_selector": ["textInput2","events","0","params"] as const,
      ...
      "_selector": ["textInput2","events","1"] as const,
      "method": "setDisabled",
      "enabled": false,
      "params": {
        "_selector": ["textInput2","events","1","params"] as const,
        /** Whether user input, interaction, or selection is disabled. */
        "disabled": true
      } as const,
      "targetId": null,
...
const textInput2 = {
  ...
  "inputTooltip": "",
  "events": _LEVEL_1["_textInput2_events"] as RetoolArrayWrapper<["textInput2","events"], typeof _LEVEL_1["_textInput2_events"], 2>,
