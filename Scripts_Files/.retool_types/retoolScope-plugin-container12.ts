const _LEVEL_1 = {
  "_container12_viewKeys": ["View 1"] as const,
  "_container12_views": [{
      "_selector": ["container12","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container12 = {
  "_selector": ["container12"] as const,
  "_isPlugin": true,
  "id": "container12",
    /**
  ...
  **/
  ...
  "viewKeys": _LEVEL_1["_container12_viewKeys"] as RetoolArrayWrapper<["container12","viewKeys"], typeof _LEVEL_1["_container12_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container12_views"] as RetoolArrayWrapper<["container12","views"], typeof _LEVEL_1["_container12_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container12","style"] as const,
