const _LEVEL_1 = {
  "_container24_viewKeys": ["View 1"] as const,
  "_container24_views": [{
      "_selector": ["container24","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container24 = {
  "_selector": ["container24"] as const,
  "_isPlugin": true,
  "id": "container24",
  ...
  "viewKeys": _LEVEL_1["_container24_viewKeys"] as RetoolArrayWrapper<["container24","viewKeys"], typeof _LEVEL_1["_container24_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container24_views"] as RetoolArrayWrapper<["container24","views"], typeof _LEVEL_1["_container24_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container24","style"] as const,
