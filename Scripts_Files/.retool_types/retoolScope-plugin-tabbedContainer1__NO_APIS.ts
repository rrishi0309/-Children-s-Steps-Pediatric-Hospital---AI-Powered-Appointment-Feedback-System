const _LEVEL_1 = {
  "_tabbedContainer1_viewKeys": ["View 1","View 2","View 3"] as const,
  "_tabbedContainer1_views": [{
      "_selector": ["tabbedContainer1","views","0"] as const,
      "key": "View 1",
      ...
      "_selector": ["tabbedContainer1","views","1"] as const,
      "key": "View 2",
      "label": "Provo",
      "tooltip": "",
      /** Whether the component is visible. */
      ...
      "_selector": ["tabbedContainer1","views","2"] as const,
      "key": "View 3",
      "label": "St. George",
      "tooltip": "",
      /** Whether the component is visible. */
...
const tabbedContainer1 = {
  "_selector": ["tabbedContainer1"] as const,
  "_isPlugin": true,
  "id": "tabbedContainer1",
  ...
  "viewKeys": _LEVEL_1["_tabbedContainer1_viewKeys"] as RetoolArrayWrapper<["tabbedContainer1","viewKeys"], typeof _LEVEL_1["_tabbedContainer1_viewKeys"], 3>,
  ...
  "views": _LEVEL_1["_tabbedContainer1_views"] as RetoolArrayWrapper<["tabbedContainer1","views"], typeof _LEVEL_1["_tabbedContainer1_views"], 3>,
