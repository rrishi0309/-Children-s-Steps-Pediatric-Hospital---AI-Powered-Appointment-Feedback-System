const _LEVEL_1 = {
  "_container9_viewKeys": ["View 1"] as const,
  "_container9_views": [{
      "_selector": ["container9","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container9 = {
  ...
  "viewKeys": _LEVEL_1["_container9_viewKeys"] as RetoolArrayWrapper<["container9","viewKeys"], typeof _LEVEL_1["_container9_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container9_views"] as RetoolArrayWrapper<["container9","views"], typeof _LEVEL_1["_container9_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container9","style"] as const,
