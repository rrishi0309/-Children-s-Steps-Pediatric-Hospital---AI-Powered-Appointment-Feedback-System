const _LEVEL_1 = {
  "_container26_viewKeys": ["View 1"] as const,
  "_container26_views": [{
      "_selector": ["container26","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container26 = {
  "_selector": ["container26"] as const,
  "_isPlugin": true,
  "id": "container26",
    /**
  ...
  **/
  ...
  "viewKeys": _LEVEL_1["_container26_viewKeys"] as RetoolArrayWrapper<["container26","viewKeys"], typeof _LEVEL_1["_container26_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container26_views"] as RetoolArrayWrapper<["container26","views"], typeof _LEVEL_1["_container26_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container26","style"] as const,
