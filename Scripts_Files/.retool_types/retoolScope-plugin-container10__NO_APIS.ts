const _LEVEL_1 = {
  "_container10_viewKeys": ["View 1"] as const,
  "_container10_views": [{
      "_selector": ["container10","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container10 = {
  "_selector": ["container10"] as const,
  "_isPlugin": true,
  "id": "container10",
  ...
  "viewKeys": _LEVEL_1["_container10_viewKeys"] as RetoolArrayWrapper<["container10","viewKeys"], typeof _LEVEL_1["_container10_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container10_views"] as RetoolArrayWrapper<["container10","views"], typeof _LEVEL_1["_container10_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container10","style"] as const,
