const _LEVEL_1 = {
  "_container4_viewKeys": ["View 1"] as const,
  "_container4_views": [{
      "_selector": ["container4","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container4 = {
  ...
  **/
  ...
  "viewKeys": _LEVEL_1["_container4_viewKeys"] as RetoolArrayWrapper<["container4","viewKeys"], typeof _LEVEL_1["_container4_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container4_views"] as RetoolArrayWrapper<["container4","views"], typeof _LEVEL_1["_container4_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container4","style"] as const,
