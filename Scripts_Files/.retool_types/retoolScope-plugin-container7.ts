const _LEVEL_1 = {
  "_container7_viewKeys": ["View 1"] as const,
  "_container7_views": [{
      "_selector": ["container7","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container7 = {
  ...
  **/
  ...
  "viewKeys": _LEVEL_1["_container7_viewKeys"] as RetoolArrayWrapper<["container7","viewKeys"], typeof _LEVEL_1["_container7_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container7_views"] as RetoolArrayWrapper<["container7","views"], typeof _LEVEL_1["_container7_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container7","style"] as const,
