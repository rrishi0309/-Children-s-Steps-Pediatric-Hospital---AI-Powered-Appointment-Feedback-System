const _LEVEL_1 = {
  "_container16_viewKeys": ["View 1"] as const,
  "_container16_views": [{
      "_selector": ["container16","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container16 = {
  "_selector": ["container16"] as const,
  "_isPlugin": true,
  "id": "container16",
    /**
  ...
  **/
  ...
  "viewKeys": _LEVEL_1["_container16_viewKeys"] as RetoolArrayWrapper<["container16","viewKeys"], typeof _LEVEL_1["_container16_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container16_views"] as RetoolArrayWrapper<["container16","views"], typeof _LEVEL_1["_container16_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container16","style"] as const,
