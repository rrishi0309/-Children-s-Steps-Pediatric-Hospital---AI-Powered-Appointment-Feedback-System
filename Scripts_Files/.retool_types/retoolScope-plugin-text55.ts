const text55 = {
  ...
  **/
  ...
  "tooltipText": "",
  /** The current value. */
  "value": "<div style=\"background-color: #0669bf; color: white; text-align: center; padding: 50px 20px; font-family: Arial, sans-serif;\">\n  <!-- Testimonials Heading -->\n  <h1 style=\"font-size: 2.5rem; font-weig...",
