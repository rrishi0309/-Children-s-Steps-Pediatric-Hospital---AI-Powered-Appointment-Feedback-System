const _LEVEL_1 = {
  "_container11_viewKeys": ["View 1"] as const,
  "_container11_views": [{
      "_selector": ["container11","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container11 = {
  "_selector": ["container11"] as const,
  "_isPlugin": true,
  "id": "container11",
    /**
  ...
  **/
  ...
  "viewKeys": _LEVEL_1["_container11_viewKeys"] as RetoolArrayWrapper<["container11","viewKeys"], typeof _LEVEL_1["_container11_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container11_views"] as RetoolArrayWrapper<["container11","views"], typeof _LEVEL_1["_container11_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container11","style"] as const,
