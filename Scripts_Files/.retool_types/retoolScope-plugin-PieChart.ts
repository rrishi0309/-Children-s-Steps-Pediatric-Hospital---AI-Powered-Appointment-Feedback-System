const _LEVEL_2 = {
  "_PieChart_gradientColorArray_0": ["0.0","#f6f6f6"] as const,
  "_PieChart_gradientColorArray_1": ["1.0","#0669bf"] as const,
}
const _LEVEL_1 = {
  "_PieChart_gradientColorArray": [_LEVEL_2["_PieChart_gradientColorArray_0"] as RetoolArrayWrapper<["PieChart","gradientColorArray","0"], typeof _LEVEL_2["_PieChart_gradientColorArray_0"], 2>,_LEVEL_2["_PieChart_gradientColorArray_1"] as RetoolArrayWrapper<["PieChart","gradientColorArray","1"], typeof _LEVEL_2["_PieChart_gradientColorArray_1"], 2>] as const,
  "_PieChart_colorArrayDropDown": ["#2196f3","#4046CA","#8bc34a","#DE3C82","#7E84FA","#f44336","#fcd6bb","#fde68a","#eecff3","#a7f3d0"] as const,
  "_PieChart_colorArray": ["#2196F3","#8BC34A","#DE3C82","#7E84FA","#FFEB3B"] as const,
  "_PieChart_selectedPoints": [] as const,
}
const PieChart = {
  "_selector": ["PieChart"] as const,
  "_isPlugin": true,
  "id": "PieChart",
    /**
  ...
  **/
  ...
  "gradientColorArray": _LEVEL_1["_PieChart_gradientColorArray"] as RetoolArrayWrapper<["PieChart","gradientColorArray"], typeof _LEVEL_1["_PieChart_gradientColorArray"], 2>,
  /** The template for the data labels */
  "textTemplate": "%{label} Stars<br>%{percent}",
  /** The color scale for the chart, manually selected */
  "colorArrayDropDown": _LEVEL_1["_PieChart_colorArrayDropDown"] as unknown as RetoolArrayWrapper<["PieChart","colorArrayDropDown"], typeof _LEVEL_1["_PieChart_colorArrayDropDown"], 38>,
  ...
  "style": {
    "_selector": ["PieChart","style"] as const,
  ...
  "colorArray": _LEVEL_1["_PieChart_colorArray"] as RetoolArrayWrapper<["PieChart","colorArray"], typeof _LEVEL_1["_PieChart_colorArray"], 5>,
  ...
  "toolbar": {
    "_selector": ["PieChart","toolbar"] as const,
  ...
  "selectedPoints": _LEVEL_1["_PieChart_selectedPoints"] as RetoolArrayWrapper<["PieChart","selectedPoints"], typeof _LEVEL_1["_PieChart_selectedPoints"], 0>,
