const text5 = {
  ...
  "tooltipText": "",
  /** The current value. */
  "value": "<div align=\"center\">\n  <h2>Welcome to Children's Steps Pediatric Hospital</h2>\n</div>\n\nAt Children’s Steps Pediatric Hospital, we are dedicated to providing exceptional, family-centered care for every...",
  "style": {
    "_selector": ["text5","style"] as const,
    "background": "#ffffff"
  } as const,
