const _LEVEL_1 = {
  "_container3_viewKeys": ["View 1"] as const,
  "_container3_views": [{
      "_selector": ["container3","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container3 = {
  ...
  "viewKeys": _LEVEL_1["_container3_viewKeys"] as RetoolArrayWrapper<["container3","viewKeys"], typeof _LEVEL_1["_container3_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container3_views"] as RetoolArrayWrapper<["container3","views"], typeof _LEVEL_1["_container3_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container3","style"] as const,
