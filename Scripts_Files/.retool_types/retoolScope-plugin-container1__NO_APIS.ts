const _LEVEL_1 = {
  "_container1_viewKeys": ["View 1"] as const,
  "_container1_views": [{
      "_selector": ["container1","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container1 = {
  ...
  "viewKeys": _LEVEL_1["_container1_viewKeys"] as RetoolArrayWrapper<["container1","viewKeys"], typeof _LEVEL_1["_container1_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container1_views"] as RetoolArrayWrapper<["container1","views"], typeof _LEVEL_1["_container1_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container1","style"] as const,
