const _LEVEL_1 = {
  "_container25_viewKeys": ["View 1"] as const,
  "_container25_views": [{
      "_selector": ["container25","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container25 = {
  "_selector": ["container25"] as const,
  "_isPlugin": true,
  "id": "container25",
  ...
  "viewKeys": _LEVEL_1["_container25_viewKeys"] as RetoolArrayWrapper<["container25","viewKeys"], typeof _LEVEL_1["_container25_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container25_views"] as RetoolArrayWrapper<["container25","views"], typeof _LEVEL_1["_container25_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container25","style"] as const,
