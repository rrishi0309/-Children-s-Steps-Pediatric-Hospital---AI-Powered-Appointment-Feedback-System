...
const table1 = {
  ...
  **/
  setFilter: (filter: {id: any, columnId: 'feedback_rating'|'id'|'feedback_name'|'feedback_type'|'feedback_message'|'submitted_at', operator: '<'|'<='|'>'|'>='|'='|'!='|'is'|'isNot'|'includes'|'doesNotInclude'|'isTrue'|'isFalse'|'isEmpty'|'isNotEmpty'|'intersects'|'isOneOf'|'isNoneOf'|'isBefore'|'isAfter', value: any}): unknown => undefined as unknown,
  /**
  ...
  **/
  setSort: (sort: {columnId: 'feedback_rating'|'id'|'feedback_name'|'feedback_type'|'feedback_message'|'submitted_at', direction: 'asc'|'desc'}): unknown => undefined as unknown,
  /**
