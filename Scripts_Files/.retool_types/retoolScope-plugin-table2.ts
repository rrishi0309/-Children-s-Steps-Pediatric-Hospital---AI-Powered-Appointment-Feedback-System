const _LEVEL_1 = {
  "_table2_sortArray": [{
      "_selector": ["table2","sortArray","0"] as const,
      "columnId": "c8541",
      "direction": "asc"
    } as const] as const,
  "_table2_groupByColumns": [] as const,
  "_table2_events": [{
      "_selector": ["table2","events","0"] as const,
      "event": "clickToolbar",
      "type": "datasource",
      "method": "trigger",
      ...
      "_selector": ["table2","events","1"] as const,
      "event": "clickToolbar",
      "type": "util",
      "method": "exportData",
      "pluginId": "",
      "targetId": "3c",
      "params": {
        "_selector": ["table2","events","1","params"] as const,
        "fileType": "xlsx",
        "options": {
          "_selector": ["table2","events","1","params","options"] as const,
      ...
      "_selector": ["table2","events","2"] as const,
      "event": "save",
      "type": "datasource",
      "method": "trigger",
  ...
  "_table2_newRows": [] as const,
}
const table2 = {
  "_selector": ["table2"] as const,
  "_isPlugin": true,
  "id": "table2",
    /**
  ...
  * 
  * `key` will target the row of the first matching item in the Table's configured primary key column, `patient_name`.
  * 
  ...
  **/
  ...
  "sortArray": _LEVEL_1["_table2_sortArray"] as RetoolArrayWrapper<["table2","sortArray"], typeof _LEVEL_1["_table2_sortArray"], 1>,
  ...
  "groupByColumns": _LEVEL_1["_table2_groupByColumns"] as RetoolArrayWrapper<["table2","groupByColumns"], typeof _LEVEL_1["_table2_groupByColumns"], 0>,
  ...
  "style": {
    "_selector": ["table2","style"] as const,
    "boxShadow": "highElevation"
  } as const,
  /** The maximum height of the overflow actions overlay. */
  "overflowActionsOverlayMaxHeight": null,
  "events": _LEVEL_1["_table2_events"] as RetoolArrayWrapper<["table2","events"], typeof _LEVEL_1["_table2_events"], 3>,
  /** An array of the newly added rows. Each new row is an object with an entry for each edited cell. */
  "newRows": _LEVEL_1["_table2_newRows"] as RetoolArrayWrapper<["table2","newRows"], typeof _LEVEL_1["_table2_newRows"], 0>,
  ...
  "pagination": {
    "_selector": ["table2","pagination"] as const,
    "currentPage": 0,
    "pageSize": 15,
