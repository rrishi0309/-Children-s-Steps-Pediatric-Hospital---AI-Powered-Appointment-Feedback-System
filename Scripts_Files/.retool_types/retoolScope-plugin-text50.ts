const text50 = {
  ...
  **/
  ...
  "tooltipText": "",
  /** The current value. */
  "value": "🔒 Note: This login is for demo purposes only. No sensitive or personal data will be collected or stored.\n\nDemo Login: admin1\nDemo Password: admin123\n\nBy continuing, you agree to access a simulated pa...",
