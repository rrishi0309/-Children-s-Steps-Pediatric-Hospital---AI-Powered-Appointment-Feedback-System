const _LEVEL_1 = {
  "_container5_viewKeys": ["View 1"] as const,
  "_container5_views": [{
      "_selector": ["container5","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container5 = {
  ...
  "viewKeys": _LEVEL_1["_container5_viewKeys"] as RetoolArrayWrapper<["container5","viewKeys"], typeof _LEVEL_1["_container5_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container5_views"] as RetoolArrayWrapper<["container5","views"], typeof _LEVEL_1["_container5_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container5","style"] as const,
