const _LEVEL_1 = {
  "_form2_events": [{
      "_selector": ["form2","events","0"] as const,
      "event": "submit",
      "type": "util",
      "method": "openPage",
      "pluginId": "",
      "targetId": null,
      "params": {
        "_selector": ["form2","events","0","params"] as const,
        "options": {
          "_selector": ["form2","events","0","params","options"] as const,
          "passDataWith": "urlParams"
        } as const,
        "pageName": "Patient_Portal"
      } as const,
      "waitType": "debounce",
      "waitMs": 0
    } as const,{
      "_selector": ["form2","events","1"] as const,
      "event": "submit",
      "type": "script",
      "method": "run",
      "pluginId": "",
      "targetId": null,
      "params": {
        "_selector": ["form2","events","1","params"] as const,
        "src": "utils.showNotification({\n  title: \"✅ Login Successful\",\n  description: `Welcome! You've been logged into the Patient Portal.`,\n  notificationType: \"success\"\n});\n\n// Optional: Navigate or set user stat..."
      } as const,
      "waitType": "debounce",
      "waitMs": 0
    } as const] as const,
...
const form2 = {
  ...
  "showFooter": true,
  "events": _LEVEL_1["_form2_events"] as RetoolArrayWrapper<["form2","events"], typeof _LEVEL_1["_form2_events"], 2>,
