const _LEVEL_1 = {
  "_container13_viewKeys": ["View 1"] as const,
  "_container13_views": [{
      "_selector": ["container13","views","0"] as const,
      "key": "View 1",
      "label": "",
      "tooltip": "",
...
const container13 = {
  "_selector": ["container13"] as const,
  "_isPlugin": true,
  "id": "container13",
    /**
  ...
  **/
  ...
  "viewKeys": _LEVEL_1["_container13_viewKeys"] as RetoolArrayWrapper<["container13","viewKeys"], typeof _LEVEL_1["_container13_viewKeys"], 1>,
  ...
  "views": _LEVEL_1["_container13_views"] as RetoolArrayWrapper<["container13","views"], typeof _LEVEL_1["_container13_views"], 1>,
  ...
  "padding": "12px",
  "style": {
    "_selector": ["container13","style"] as const,
