const _LEVEL_1 = {
  "_chat1_query1_chatHistory": [] as const,
}
const chat1_query1 = {
  "_selector": ["chat1_query1"] as const,
  "_isPlugin": true,
  "id": "chat1_query1",
    /**
  ...
  **/
  ...
  "systemMessage": "You are **Ken AI**, a friendly and knowledgeable assistant for **Children’s Steps Pediatric Hospital**, here to help families learn more about our services, staff, and mission.\n\nYou are the **public-f...",
  ...
  "providerName": "openAI",
  "enableCaching": false,
  "chatHistory": _LEVEL_1["_chat1_query1_chatHistory"] as RetoolArrayWrapper<["chat1_query1","chatHistory"], typeof _LEVEL_1["_chat1_query1_chatHistory"], 0>,
  "imageContent": "",
